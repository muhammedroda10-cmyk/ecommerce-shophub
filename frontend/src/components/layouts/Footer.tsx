        ...
        <footer className="border-t border-gray-200 bg-gray-50">
            <div className="container-custom py-12">
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                    {/* Company Info */}
                    <div>
                        <h3 className="mb-4 text-lg font-bold text-gradient">ShopHub</h3>
                        <p className="mb-4 text-sm text-gray-600">
                            Your one-stop marketplace for quality products from trusted sellers worldwide.
                        </p>
                        <div className="flex gap-4">
                            <a href="#" className="text-gray-400 transition-colors hover:text-primary-600">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            <li><Link href="/category/electronics" className="text-gray-600 hover:text-primary-600">Electronics</Link></li>
                            <li><Link href="/category/fashion" className="text-gray-600 hover:text-primary-600">Fashion</Link></li>
                            <li><Link href="/category/home-living" className="text-gray-600 hover:text-primary-600">Home & Living</Link></li>
                            <li><Link href="/category/sports" className="text-gray-600 hover:text-primary-600">Sports</Link></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link href="/track-order" className="text-gray-600 hover:text-primary-600">Track Order</Link></li>
                            <li><Link href="/returns" className="text-gray-600 hover:text-primary-600">Returns</Link></li>
                    ...
                    {/* About */}
                    <div>
                        <h4 className="mb-4 font-semibold text-gray-900">About ShopHub</h4>
                        <ul className="space-y-2 text-sm">
                            <li><Link href="/about" className="text-gray-600 hover:text-primary-600">About Us</Link></li>
                            <li><Link href="/become-seller" className="text-gray-600 hover:text-primary-600">Become a Seller</Link></li>
                            <li><Link href="/careers" className="text-gray-600 hover:text-primary-600">Careers</Link></li>
                            <li><Link href="/press" className="text-gray-600 hover:text-primary-600">Press</Link></li>

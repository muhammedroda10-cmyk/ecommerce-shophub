                    ...
                    {categories.map((category: any) => (
                        ...
                        >
                            <div className="aspect-[4/3] bg-gray-100 relative overflow-hidden">
                                ...
                                <div className="absolute inset-0 flex items-center justify-center bg-primary-50 text-6xl text-primary-200 transition-transform duration-500 group-hover:scale-110">
                            ...
                            <div className="flex flex-1 flex-col justify-between p-6">
                                ...
                                <div className="mt-4 flex items-center justify-between border-t border-gray-100 pt-4">
                                    ...
                                    <span className="rounded-full bg-primary-50 px-3 py-1 text-xs font-semibold text-primary-600 group-hover:bg-primary-100">
                                        View Collection
                                    </span>
                                </div>
                            </div>
